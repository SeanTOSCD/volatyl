...
define( 'EDD_SL_THEME_NAME', 'Volatyl Framework' ); // add your own unique prefix to prevent conflicts
...
if ( !class_exists( 'EDD_SL_Theme_Updater' ) ) {
	...
	include( dirname( __FILE__ ) . '/vol-updater.php' );
}
...
$edd_updater = new EDD_SL_Theme_Updater( array( 
		...
		'author'			=> 'Sean Davis'	// The author's name
	)
);
