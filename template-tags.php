		...
		switch ( $comment->comment_type ) {
			...
			default :
				...
				if ( $comment->comment_approved == '0' )
					echo "{$tab3}<em>", __( 'Your comment is awaiting moderation.', 'volatyl' ), "</em><br />\n";
...
function volatyl_categorized_blog() {
	...
	if ( '1' != $all_the_cool_cats )
		...
		// This blog has more than 1 category so volatyl_categorized_blog should return true
		return true;
	else
	
		// This blog has only 1 category so volatyl_categorized_blog should return false
		return false;
